...
class Start(serge.actor.Actor, common.MoveableBackground):
    ...
    def __init__(self, game, world):
        ...
        b.visual = serge.blocks.visualblocks.SpriteText('Start', G('text-button-colour'), 'big_button_back', font_size=G('start-text-size'))
        ...
        self.version.setOrigin(G('version-x'), G('version-y'))
