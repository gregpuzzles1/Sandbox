...
# Change this to change the default font used when creating text objects
...
class Store(registry.GeneralStore):
    ...
    def registerFromFiles(self, name, path, number, framerate=0, running=False, rectangular=True, angle=0.0, zoom=1.0, start=1):
